    ...
    <section className="py-10 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-5 sm:gap-6">
          ...
          {/* ========================================================== */}
          {/* CARD 1: MUGS MÁGICOS (Grande y destacado, span 7)          */}
          {/* ========================================================== */}
          <div
            onClick={() => onSelectCategory('mugs-magicos')}
            className="lg:col-span-7 bg-white/90 backdrop-blur-md rounded-3xl border-2 border-purple-200/90 p-6 sm:p-7 shadow-card hover:shadow-soft hover:border-purple-400 hover:scale-[1.01] transition-all cursor-pointer flex flex-col justify-between group relative overflow-hidden"
          >
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-2 max-w-md leading-relaxed">
                En frío una taza negra sobria que oculta el diseño. Al contacto con café, chocolate o bebidas calientes, ¡ocurre la magia y revela tus fotos familiares!
              </p>
          ...
          {/* ========================================================== */}
          {/* CARD 2: CAMISETAS PARA EVENTOS (Vertical elegante, span 5) */}
          {/* ========================================================== */}
          <div
            onClick={() => onSelectCategory('camisetas')}
            className="lg:col-span-5 bg-white/90 backdrop-blur-md rounded-3xl border-2 border-purple-200/90 p-6 sm:p-7 shadow-card hover:shadow-soft hover:border-purple-400 hover:scale-[1.01] transition-all cursor-pointer flex flex-col justify-between group relative overflow-hidden"
          >
