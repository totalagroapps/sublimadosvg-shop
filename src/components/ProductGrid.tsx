...
export const ProductGrid: React.FC<ProductGridProps> = ({
  ...
  return (
    <section id="catalogo" className="py-12 sm:py-16 bg-cream border-b border-rose-100 scroll-mt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      
      {/* Marketplace Catalog Header */}
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
        <div>
          <div className="inline-flex items-center gap-1.5 text-xs font-extrabold uppercase tracking-wider text-rose-600 bg-rose-50 px-3 py-1 rounded-full mb-2 border border-rose-200">
        ...
        <div className="flex flex-wrap items-center gap-3 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center gap-1 text-xs">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl font-bold transition-colors ${
                priceFilter === 'under30' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
              &lt; $30k
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-xl font-bold transition-colors ${
                priceFilter === '30to45' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
              $30k - $45k
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-xl font-bold transition-colors ${
                priceFilter === 'over45' ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100'
              }`}
            >
              &gt; $45k
            </button>
          ...
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <select
              ...
              className="bg-slate-50 border border-slate-200 text-slate-700 font-semibold rounded-xl px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-rose-500 cursor-pointer text-xs"
            >
