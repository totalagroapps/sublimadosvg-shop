...
export const MarketHero: React.FC<MarketHeroProps> = ({ onSelectCategory, onExploreClick }) => {
  ...
  const slides: BannerSlide[] = [
    ...
    {
      id: 'slide-cumple',
      tag: '🎉 Fiestas Infantiles & Parejas',
      title: 'Celebra momentos únicos con',
      highlight: 'camisetas personalizadas',
      subtitle: 'Temáticas de Mickey "Mi Primer Añito", Stitch "Ella es Mía" y combos familiares a juego.',
      image: '/prod-camisetas-fe.webp',
      category: 'camisetas',
      ctaText: 'Ver Camisetas',
      badge: 'Sublimación HD Tacto Cero 👕',
      gradient: 'from-rose-950/85 via-rose-900/55 to-slate-950/80',
    },
    {
      id: 'slide-mugs',
      tag: '☕ Mugs, Tazas Mágicas & Vasos Térmicos',
      title: 'Tu café matutino con',
      highlight: 'mensajes que bendicen tu día',
      subtitle: 'Mugs de cerámica AAA bicolor, tazas térmicas mágicas que revelan tu diseño con el calor y termos 20oz.',
      image: '/prod-mugs-fe.webp',
      category: 'mugs',
      ctaText: 'Ver Mugs & Termos',
      badge: 'Cerámica AAA Brillante ☕',
