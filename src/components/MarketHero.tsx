            ...
            <div className="absolute inset-0 p-6 sm:p-10 flex flex-col justify-between text-white z-10">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <a
                  ...
                  className="px-4 sm:px-5 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 hover:from-purple-700 hover:via-pink-600 hover:to-purple-700 text-white text-xs sm:text-sm font-bold shadow-md hover:scale-105 transition-all flex items-center gap-1.5"
                >
