...
export const PromoBannerGrid: React.FC<PromoBannerGridProps> = ({
  ...
  const banners = [
    ...
    },
    {
      ...
      subtitle: 'Camisetas temáticas y bodies infantiles personalizados a solo $25.000.',
      gradient: 'from-amber-500 via-orange-500 to-rose-600',
      shadow: 'shadow-amber-500/20',
      badge: 'A solo $25.000 🎂',
      category: 'camisetas' as ProductCategory,
      image: '/prod-camiseta-ajolote.jpg',
      whatsappText: '¡Hola Viviana! Quiero cotizar camisetas personalizadas para un evento / cumpleaños a $25.000.',
    },
    {
      id: 'banner-fe',
      tag: 'Inspiración & Fe',
