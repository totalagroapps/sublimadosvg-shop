  ...
  const banners = [
    {
      ...
      subtitle: 'Camisetas "Ella es Mía" + Rompecabezas en forma de corazón.',
      gradient: 'from-rose-600 via-pink-600 to-red-600',
      shadow: 'shadow-rose-500/20',
      badge: 'Regalo Perfecto ❤️',
      category: 'camisetas' as ProductCategory,
      image: '/prod-camiseta-stitch.webp',
      whatsappText: '¡Hola! Me gustaría cotizar el Combo de Parejas (Camisetas Stitch + Rompecabezas Corazón).',
    },
    {
      id: 'banner-cumple',
      tag: 'Fiestas & Cumpleaños',
      icon: Gift,
      title: 'Cumpleaños Infantiles',
      subtitle: 'Camisetas "Mi 1er Añito" Mickey/Personajes + Cake Topper 3D en capas.',
      gradient: 'from-amber-500 via-orange-500 to-rose-600',
      shadow: 'shadow-amber-500/20',
      badge: 'Personalizado 🎂',
      category: 'camisetas' as ProductCategory,
      image: '/prod-camiseta-mickey.webp',
      whatsappText: '¡Hola Viviana! Quiero cotizar camisetas personalizadas para el cumpleaños de mi hijo/a.',
    },
    {
      id: 'banner-fe',
      tag: 'Inspiración & Fe',
